OS required: linux.cs.mcgill.ca
...
7) I have no idea why when i do ./mykernel < testfile.txt on my terminal on my mac there are no segmentation faults but when i do the exact same on linux sometimes it appear but sometimes it doesn't 
